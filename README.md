...
## Demo
Link: [https://car-predictor1.herokuapp.com/](https://car-predictor1.herokuapp.com/)



## Overview
This is a Flask web app which predicts Car price for the used cars.
...
## Bug / Feature Request
Since the model is trained with small dataset, it is giving wrong prediction for small Present Price 
